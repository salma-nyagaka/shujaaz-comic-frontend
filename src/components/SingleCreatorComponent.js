...
const SingleCreatorComponent = props => {
  return (
    <div>
           <div>
=    <div className='row'>
      {/* {props.creator.data.map((story, index) => (
...
<h3 className="made_by">Made with ♡</h3>
  ...
  <div className="profile-container-forms">
